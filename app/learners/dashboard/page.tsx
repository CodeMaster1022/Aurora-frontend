  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1A1A33] via-purple-900 to-[#1A1A33] pt-24 px-4 sm:px-6">
      ...
      <Dialog open={ratingDialogOpen} onOpenChange={setRatingDialogOpen}>
        <DialogContent className="bg-[#1A1A33] border-purple-500/20 text-white max-w-md">
          <DialogHeader>
          ...
          <div className="space-y-4">
            {selectedSession && (
              <div className="p-3 bg-white/5 rounded-lg">
                ...
                <p className="text-sm text-gray-400">
                  with {typeof selectedSession.speaker === 'object' 
                    ? `${selectedSession.speaker.firstname} ${selectedSession.speaker.lastname}`
            ...
            <div>
              <Label className="text-white mb-2">Your Review</Label>
              <Textarea
                value={reviewComment}
