...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    'about.faq.a2': 'Conversational level of English',
  ...
  es: {
    ...
    'about.mission.p1': 'Hacer que la práctica de idiomas sea accesible, humana y placentera para estudiantes y hablantes reflexivos, brindándoles todo lo que necesitan para conectar, crecer y pertenecer.',
    ...
    'about.faq.a2': 'Nivel conversacional de inglés',
